...
`0.1.10a0`. Use the release label for tags and GitHub release names, for example
`v0.1.10-alpha`.
...
```powershell
python scripts/release_command_index.py --version 0.1.10a0 --date 2026-06-18 --format markdown --output $env:TEMP\agentledger-release-command-index.md
python scripts/check_release_process.py --version 0.1.10a0 --date 2026-06-18
```
...
```powershell
python scripts/rehearse_release.py --version 0.1.10a0 --date 2026-06-18 --output-dir $env:TEMP\agentledger-release-rehearsal-0.1.10-alpha
python scripts/verify_release_rehearsal.py $env:TEMP\agentledger-release-rehearsal-0.1.10-alpha\release-rehearsal-manifest.json
python scripts/release_artifact_doctor.py --version 0.1.10a0 --stage rehearsal --rehearsal-manifest $env:TEMP\agentledger-release-rehearsal-0.1.10-alpha\release-rehearsal-manifest.json
python scripts/release_rehearsal_receipt.py $env:TEMP\agentledger-release-rehearsal-0.1.10-alpha\release-rehearsal-manifest.json --format markdown --output $env:TEMP\agentledger-release-rehearsal-0.1.10-alpha\release-rehearsal-receipt.md
```

Then run the release prep dry run:

```powershell
python scripts/prepare_release.py --version 0.1.10a0 --date 2026-06-18 --release-notes-output $env:TEMP\agentledger-0.1.10-alpha-release.md --dry-run
```

Then write the source changes and draft release notes:

```powershell
python scripts/prepare_release.py --version 0.1.10a0 --date 2026-06-18 --release-notes-output $env:TEMP\agentledger-0.1.10-alpha-release.md
```
...
python scripts/release_notes.py --version 0.1.10a0 --check
python -m pytest
...
Use a release-prep branch such as `alpha-release-0.1.10` and open a draft PR. The
...
Create a prerelease from tag `v0.1.10-alpha` using the draft notes generated by
...
```powershell
python scripts/release_artifact_doctor.py --version 0.1.10a0 --stage final-notes --release-check-json $env:TEMP\agentledger-release-check.json --release-check-summary $env:TEMP\agentledger-release-check-summary.md
python scripts/finalize_release_notes.py --version 0.1.10a0 --release-check-json $env:TEMP\agentledger-release-check.json --release-check-summary $env:TEMP\agentledger-release-check-summary.md --pr-ci-url https://github.com/Martin123132/AgentLedger/actions/runs/<pr-run> --master-ci-url https://github.com/Martin123132/AgentLedger/actions/runs/<master-run> --release-readiness-url https://github.com/Martin123132/AgentLedger/actions/runs/<release-readiness-run> --tag-ci-url https://github.com/Martin123132/AgentLedger/actions/runs/<tag-run> --merge-sha <merge-sha> --output $env:TEMP\agentledger-0.1.10-alpha-release.md
python scripts/release_notes.py --version 0.1.10a0 --notes-file $env:TEMP\agentledger-0.1.10-alpha-release.md --check-publish-ready
gh release create v0.1.10-alpha --repo Martin123132/AgentLedger --title v0.1.10-alpha --notes-file $env:TEMP\agentledger-0.1.10-alpha-release.md --prerelease
```
...
```powershell
git status --short --branch
gh release view v0.1.10-alpha --repo Martin123132/AgentLedger
python scripts/release_artifact_doctor.py --version 0.1.10a0 --stage post-release --release-check-json $env:TEMP\agentledger-release-check.json --release-check-summary $env:TEMP\agentledger-release-check-summary.md --release-notes $env:TEMP\agentledger-0.1.10-alpha-release.md
python scripts/post_release_check.py --version 0.1.10a0 --release-check-json $env:TEMP\agentledger-release-check.json --release-check-summary $env:TEMP\agentledger-release-check-summary.md --release-notes $env:TEMP\agentledger-0.1.10-alpha-release.md --output-dir $env:TEMP\agentledger-post-release-0.1.10-alpha
python scripts/release_notes.py --version 0.1.10a0 --check
```
...
```powershell
python scripts/check_github_release.py --version 0.1.10a0 --format json --output $env:TEMP\agentledger-github-release-check.json
python scripts/check_github_release.py --version 0.1.10a0 --format markdown --output $env:TEMP\agentledger-github-release-check.md
python scripts/release_artifact_doctor.py --version 0.1.10a0 --stage evidence-packet --release-check-json $env:TEMP\agentledger-release-check.json --release-check-summary $env:TEMP\agentledger-release-check-summary.md --release-notes $env:TEMP\agentledger-0.1.10-alpha-release.md --github-release-check-json $env:TEMP\agentledger-github-release-check.json
python scripts/release_evidence_packet.py --version 0.1.10a0 --release-check-json $env:TEMP\agentledger-release-check.json --release-check-summary $env:TEMP\agentledger-release-check-summary.md --release-notes $env:TEMP\agentledger-0.1.10-alpha-release.md --github-release-check-json $env:TEMP\agentledger-github-release-check.json --output $env:TEMP\agentledger-release-evidence.md --json-output $env:TEMP\agentledger-release-evidence.json
```
