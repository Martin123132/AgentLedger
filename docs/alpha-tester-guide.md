...
- `pack-alpha` validates that share-safe packet, prints the two files to send, and includes a `Sharing` section with keep-private reminders plus `public_summary` snippets for GitHub issues or short updates
