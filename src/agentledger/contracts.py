...
JSON_CONTRACTS: list[dict[str, Any]] = [
    ...
    {
        "command": "verify-chain --format json",
        "schema_version": "agentledger.verify_chain.v1",
        "purpose": "Verify canonical report digests and previous-run links across local history.",
        "stable_fields": [
            "ok",
            "status",
            "out",
        ...
        "exit_codes": {"0": "history valid or partially covered by legacy reports", "2": "history missing or broken"},
    },
    {
    ...
    {
        "command": "open-packet --format json",
        "schema_version": "agentledger.open_packet.v1",
        "purpose": "Locate the latest share-safe alpha packet without parsing terminal output.",
        "stable_fields": [
            "ok",
            "repo",
            "out",
        ...
        "exit_codes": {
            "0": "latest packet pointer resolved and packet files exist",
            "2": "latest packet pointer is missing, unreadable, invalid, or points at missing files",
        },
    },
    {
        ...
        "exit_codes": {"0": "support checklist printed"},
    },
    {
